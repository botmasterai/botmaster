...
class BaseBot extends EventEmitter {
  ...
  */
   ...
   * pre and post functions can be used to do actions either before or after
   * the sending of the essage is done (consider using 'outgoing' middleware)
   * when more appropriate however.
   *
