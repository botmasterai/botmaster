  ...
  */
  ...
  __runIncomingMiddleware(preMiddlewareUpdate) {
    return new Promise((resolve, reject) => {
      ...
      return this.incomingMiddleware.run(patchedBot, preMiddlewareUpdate, cb);
    });
  }
  ...
  __runOutgoingMiddleware(preMiddlewareMessage, sendOptions) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const patchedBot = this.__createBotPatchedWithUpdate(sendOptions.__update);
      ...
      return this.outgoingMiddleware.run(
