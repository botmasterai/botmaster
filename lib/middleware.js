...
class Middleware {
   ...
   * TODO: make botReceives and botSends more flexible, I.e. I can
   * require the bot to receive or send multiple types of messages using
   * space (or comma delimited strings) or arrays. Code for solving that is in
   * the botmaster-cli package
   * @ignore
