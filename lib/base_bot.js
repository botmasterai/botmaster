...
class BaseBot extends EventEmitter {
  ...
  */
   ...
   * See botmaster #use for more infor.
   *
   ...
   */
  use(middlewareType, options, cb) {
    this.middleware.use(middlewareType, options, cb);
  }
   ...
   */
  useWrapped(callbacks) {
    this.middleware.useWrapped(callbacks);
  }
